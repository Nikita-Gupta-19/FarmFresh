	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">FarmFresh<span>Delhi</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9818134486</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto: farmfresh2025@gmail.com" style="color:white">farmfresh2025@gmail.com</a></p>
			</div>
		</div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				...
				FarmFresh is an e-commerce trading platform for grains & groceries...
			</p>
