...
<html lang="en">
	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Farm Fresh</h2>
				<p>Where Freshness meets Fairness!</p>
				<br><br>
				<center>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Farm Fresh &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Where Freshness meets Fairness !</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Farm Fresh Fam<span>Vormir</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:Farm Fresh@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Farm Fresh</b></span>
				Farm Fresh is e-commerce trading platform for grains & grocerries...
			</p>
  ...
  <form class="modal-content animate" action="Login/login.php" method='POST'>
    ...
    <input type="radio" id="farmer_login" name="category" value="1">
    <label for="farmer_login">Farmer</label>
</div>
<div class="3u 12u$(small)">
    <input type="radio" id="buyer_login" name="category" value="0">
    <label for="buyer_login">Buyer</label>
</div>
									</div>
									<center>
									<div class="row uniform">
...
<div class="3u 12u$(small)">
    ...
    <label for="buyer_signup">Buyer</label>
</div>
								</div>
								<div class="row uniform">
									<div class="3u 12u$(small)">
