    ...
    <header class="header">
     ...
     height="100px" width="100px" alt="" style="border-radius: 70%;">
      ...
      <nav class="navbar">
       ...
       <div> <button onclick="openWebsite()">Login/SignUp</button></div>
      ...
      <div class="container">
        <br>
          <div id="searchResults">
            <iframe id="if1" width="60%" height="254" style="visibility:visible" src="https://www.google.com/search?igu=1"></iframe>
